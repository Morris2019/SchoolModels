...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("GhanaModels.ModelsListener, GhanaModels", ModelsListener.class, __md_methods);
	}


	public ModelsListener ()
	{
		super ();
		if (getClass () == ModelsListener.class)
			mono.android.TypeManager.Activate ("GhanaModels.ModelsListener, GhanaModels", "", this, new java.lang.Object[] {  });
	}
