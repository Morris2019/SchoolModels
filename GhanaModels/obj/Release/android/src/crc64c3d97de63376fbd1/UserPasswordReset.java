...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("GhanaModels.UserPasswordReset, GhanaModels", UserPasswordReset.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == UserPasswordReset.class)
			mono.android.TypeManager.Activate ("GhanaModels.UserPasswordReset, GhanaModels", "", this, new java.lang.Object[] {  });
	}
